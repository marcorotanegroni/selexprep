...
### [`01_quickstart.ipynb`](https://github.com/marcorotanegroni/selexprep/blob/main/examples/01_quickstart.ipynb) — toy reproducibility smoke-test
...
### [`02_library_report.ipynb`](https://github.com/marcorotanegroni/selexprep/blob/main/examples/02_library_report.ipynb) — interpreting real `LibraryReport`s
