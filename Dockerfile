...
#
# Build:   docker build -t selexprep:0.1.1 .
# Run:     docker run --rm selexprep:0.1.1 inspect SRR1234567
#          docker run --rm -v "$PWD":/data selexprep:0.1.1 run /data/accessions.tsv --outdir /data/out
#
