...
#
# Build:   docker build -t selexprep:0.3.0 .
# Run:     docker run --rm selexprep:0.3.0 inspect SRR1234567
#          docker run --rm -v "$PWD":/data selexprep:0.3.0 run /data/accessions.tsv --outdir /data/out
#
